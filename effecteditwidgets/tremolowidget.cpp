...
TremoloWidget::TremoloWidget(QWidget *parent) :
    EffectEditBaseWidget(parent)
{
    ...
    mainlyt->addWidget(new QLabel(tr("LSH Freq")), 0, 3);
    ...
    mainlyt->addWidget(lshspinBox, 1, 3);

    mainlyt->addWidget(new QLabel(tr("LSH Gain")), 0, 4);
    dspinBox = new QDoubleSpinBox();
