...
ReverbPanWidget::ReverbPanWidget(QWidget *parent) :
    EffectEditBaseWidget(parent)
{
    ...
    QGroupBox *chorusGroupBox = new QGroupBox("Pan");
    ...
    chorusLayout->addWidget(new QLabel(tr("Depth")), 2, 0);
    spinBox = new QSpinBox();
    spinBox->setMinimum(0);
    spinBox->setMaximum(100);
    spinBox->setSuffix(" %");
    ...
    chorusLayout->addWidget(new QLabel(tr("Direction")), 2, 1);
    ...
    chorusLayout->addWidget( directionComboBox, 3, 1);
