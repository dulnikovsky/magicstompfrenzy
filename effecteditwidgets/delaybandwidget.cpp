...
DelayBandWidget::DelayBandWidget(int offset, QWidget *parent) :
    EffectEditBaseWidget(parent)
{
    ...
    mainlyt->addWidget(new QLabel(tr("Time")), 0, col);
    ...
    mainlyt->addWidget(new QLabel(tr("Low Cut Filter")), 0, col);
    dspinBox = createStandard10DblSpinBox(0);
    mainlyt->addWidget(dspinBox, 1, col++);

    mainlyt->addWidget(new QLabel(tr("High Cut Filter")), 0, col);
    dspinBox = createStandard10DblSpinBox(1);
    mainlyt->addWidget(dspinBox, 1, col++);

    mainlyt->addWidget(new QLabel(tr("Feedback")), 0, col);
